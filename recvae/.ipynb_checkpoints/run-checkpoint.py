...
# model_best_train = VAE(**model_kwargs).to(device)
...
for epoch in range(args.n_epochs):
    ...
    if args.implicitslim and epoch % args.step == args.step - 1:
        # Reload model best
        # model.load_state_dict(deepcopy(model_best.state_dict()))
    ...
    if valid_scores[-1] > best_ndcg:
        ...
        torch.save(model_best.state_dict(), args.save_model)

    
    torch.save(model.state_dict(), "currect_model.pt")
